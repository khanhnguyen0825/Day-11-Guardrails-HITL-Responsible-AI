        ...
        *,
        ...
        if not cf_result["safe"]:
            ...
            llm_response.content = types.Content(
                role="model",
                parts=[types.Part.from_text(text=cf_result["redacted"])]
            )
            ...
            if not sj_result["safe"]:
                ...
                llm_response.content = types.Content(
                    ...
                    parts=[types.Part.from_text(
                        text="I apologize, but I cannot provide that information as it "
                             "may violate our safety policies. How else can I help?"
                    )]
                )
